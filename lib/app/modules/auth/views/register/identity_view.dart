...
class IdentityView extends GetView<IdentityController> {
  ...
  Widget build(BuildContext context) {
    ...
    final identCont = Get.put(IdentityController());
    return Scaffold(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                shrinkWrap: true,
                itemCount: identCont.identityType.length,
                      ...
                      ListTile(
                        ...
                        trailing: Obx(
                          () => Radio<String>(
                            ...
                            value: identCont.identityType[index],
                            groupValue: identCont.selectedType.value,
                            onChanged: (value) {
                              identCont.selectedType.value = value!;
                            },
                          ),
                        ),
                      ),
              ...
              TextFormField(
                controller: identCont.identityNumberController,
                validator: (v) {
                  if (v?.isEmpty ?? true) {
              ...
              GetBuilder(
                ...
                builder: (controller) => identCont.identityImage == null
                    ? AddPhotoButton(
                        ontap: () {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            identCont.pickFromCamera(context);
                                          },
                                          child: SizedBox(
                                            height: 86,
                                            width: 163,
                                        ...
                                        InkWell(
                                          onTap: () {
                                            identCont.pickFromGallery(context);
                                          },
                                          child: SizedBox(
                                            height: 86,
                                            width: 163,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: FileImage(
                                      File(identCont.identityImage!.path),
                                    ),
                                    fit: BoxFit.cover,
                                  ),
                                ),
