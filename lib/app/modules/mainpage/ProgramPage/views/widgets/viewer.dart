...
class Viewer extends StatefulWidget {
  final String link;
  const Viewer({super.key, required this.link});
...
class _ViewerState extends State<Viewer> {
  ...
  void showViewer() async {
    ...
    await PdftronFlutter.openDocument(widget.link);
    ...
    await PdftronFlutter.openDocument(widget.link, config: config);
  ...
  void _onDocumentViewCreated(DocumentViewController controller) async {
    ...
    await controller.openDocument(widget.link, config: config);
  }
